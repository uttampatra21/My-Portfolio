...
Shery.imageEffect([""], {
  style: 3,
  config: {
    uFrequencyX: { value: 11.79, range: [0, 100] },
    uFrequencyY: { value: 11.61, range: [0, 100] },
    uFrequencyZ: { value: 11.61, range: [0, 100] },
...
// let video = document.getElementById("videoMargue");
